 ...
 * @author David Cairns
 * <p>
 * Core Driver.Game class that implements default game loop. Subclasses should
...
public abstract class GameCore extends JFrame implements KeyListener, MouseListener {
    ...
    // Used to calculate frames per second (FPS)
    private long frames;
    ...
    private void init(boolean full, int xres, int yres) {
        ...
        setResizable(false);    // Disallow resizing frame
        setLocationRelativeTo(null); // Display in center of screen
    ...
    public float getFPS() {
        ...
        return Float.parseFloat(DF.format(frames / ((currTime - startTime) / 1000.0f)));
    }
